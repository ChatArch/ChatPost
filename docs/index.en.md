...
ChatPost's current user-visible focus is the **pure browser login foundation plus separate draft entrypoints**: discover platforms, discover Profiles, check Zhihu/Xiaohongshu web login state, open a login handoff, log out / clear state, create Zhihu drafts through Wechatsync, and provide a Xiaohongshu browser-level login-link handoff.

| Scenario | Document |
| --- | --- |
| Run login and draft flows now | [Quickstart: Browser Login, Zhihu Drafts, and Xiaohongshu Login](quickstart.md) |
